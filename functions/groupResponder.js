...
*_iMavyAgent — Automação Inteligente_*`;
            ...
            } else if (normalizedText.startsWith('/restart')) {
                await sock.sendMessage(groupId, { text: '🔄 Reiniciando bot...' });
